...
int main() {
    ...
    Shader lightCubeShader("../shader/point_light/cube.vs.glsl", "../shader/point_light/cube.fs.glsl");
    Shader lightShader("../shader/point_light/light.vs.glsl", "../shader/point_light/light.fs.glsl");
