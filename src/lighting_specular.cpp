...
int main() {
    ...
    Shader lightShader("../shader/lighting_specular/light.vs.glsl", "../shader/lighting_specular/light.fs.glsl");
    Shader lightCubeShader("../shader/lighting_specular/cube.vs.glsl", "../shader/lighting_specular/cube.fs.glsl");
