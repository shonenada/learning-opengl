...
int main() {
    ...
    Shader lightShader("../shader/material/light.vs.glsl", "../shader/material/light.fs.glsl");
    Shader lightCubeShader("../shader/material/cube.vs.glsl", "../shader/material/cube.fs.glsl");
